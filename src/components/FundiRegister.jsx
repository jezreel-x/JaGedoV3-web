...
const tableData = Array.from({ length: 40 }, (_, i) => ({
  ...
  skill: ["Mason", "Plumber", "Painter", "Welder", "Electrician"][i % 5],
  grade: ["Master", "Skilled", "unskilled", "semi-skilled"][i % 4],
  firstName: "Jay",
  lastName: "Lee",
  nationalID: 38018271,
  phoneNo: "0114212111",
...
export default function AdminPortal() {
  ...
  const [activeNav, setActiveNav] = useState("Fundi");
            ...
            <tbody>
              {paginatedData.map((row, rowIndex) => (
                <tr
                  ...
                  onClick={() => navigate("/fundi/fundi-verification")}
                >
