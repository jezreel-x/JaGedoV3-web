...
const tableData = Array.from({ length: 40 }, (_, i) => ({
  ...
  skill: ["Water", "Building Works", "Mechanical", "Roads & Civil", "Electrical", ][i % 5],
  class: ["6", "5", "4", "3"][i % 4],
  // firstName: "Jay",
  Name: "Jagedo Limited",
  // nationalID: 38018271,
  ...
  status: ["Verified", "Signup", "Suspended", "Blacklisted"][i % 4],
...
export default function AdminPortal() {
  ...
  const [activeNav, setActiveNav] = useState("Contractor"); // Active nav state
          ...
          {navItems.map((nav, index) => (
            <button
              ...
              onClick={() => {
                ...
                if (nav.name === "Contractor") navigate("/Contractor-register");
                else if (nav.name === "Fundi") navigate("/fundi-register");
