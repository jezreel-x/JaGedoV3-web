...
const ImageUploader = ({ images, setImages }) => {
  ...
  */
  ...
  // Save images to localStorage and update state
  const updateImagesAndStorage = (updatedImages) => {
  ...
  */
  ...
  const handleImageUpload = (e) => {
    ...
    const updated = [...images, ...newImages];
    updateImagesAndStorage(updated); 
    */
  }
    ...
    <div className='flex w-full space-x-2'>
      <div className="flex flex-wrap gap-6">
        {images.map((img, index) => (
          <div key={index} className="flex w-40 h-40 flex-col items-center relative aspect-square border-gray-500 rounded overflow-hidden">
            ...
            <img
              ...
              className="object-cover rounded w-40 h-32"
            />
            <button
              type='button'
      ...
      {images.length < 3 && (
        ...
        {/*
        <div>
          {/* <p className='font-semibold text-gray-700 mb-2 text-center'>Side Elevation</p> 
          <label className="w-40 h-40 flex flex-col gap-2 items-center justify-center border-2 border-gray-400 border-dashed rounded cursor-pointer aspect-square hover:border-teal-500">
            Side Elevation
            <input
              type="file"
        ...
        <div>
          {/* <p className='font-semibold text-gray-700 mb-2 text-center'>Back Elevation</p> 
          <label className="w-40 h-40 flex flex-col gap-2 items-center justify-center border-2 border-gray-400 border-dashed rounded cursor-pointer aspect-square hover:border-teal-500">
            Back Elevation
            <input
              type="file"
