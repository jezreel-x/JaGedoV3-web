...
const ShowDeleteModal = ({ setShowDeleteModal, confirmDelete }) => {
    return (
        <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50">
            ...
            <p className="mb-6 text-gray-700">Are you sure you want to delete this category?</p>
