...
export default function Individual() {
  ...
  const handleChange = (e) => {
    ...
    setIsEditing(false); // hide dropdown after selecting
  };
                ...
                <form className="space-y-4">
                  <div className="space-y-2 relative">
                    ...
                    <div className="flex items-center border-b focus-within:border-b-[rgb(0,0,122)] transition-all">
                      ...
                      />
                      <Link to="/hardwarePortal/account-info/edit-organization">
                        <FiEdit
                      ...
                      {!isEditing ? (
                        <>
                          <input
                            ...
                            value={category}
                            readOnly
                            className="w-full px-4 py-2 outline-none bg-transparent cursor-default"
                          />
                          <FiEdit
                            className="text-[rgb(0,0,122)] cursor-pointer hover:opacity-75"
                            size={15}
                        ...
                        <select
                          ...
                          className="w-full px-4 py-2 outline-none bg-white border rounded text-sm"
                        >
                          {options.map((option) => (
                  ...
                  <div className="space-y-2 relative">
                    ...
                    <div className="flex items-center border-b focus-within:border-b-[rgb(0,0,122)] transition-all">
                      <input
                        ...
                        className="w-full px-4 py-2 outline-none"
                      />
                      <Link to="/hardwarePortal/account-info/edit-contactPerson">
                        <FiEdit
                          className="text-[rgb(0,0,122)] cursor-pointer hover:opacity-75"
                          size={15}
                        />
