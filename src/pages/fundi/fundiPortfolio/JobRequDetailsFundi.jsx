        ...
        <div className="p-4 sm:p-8 my-6 rounded-xl shadow-lg bg-white hover:shadow-xl transition-all duration-300 border border-gray-200">
          ...
          <div className="flex flex-col md:flex-row justify-between gap-6">
            ...
            <div className="md:w-1/2 space-y-4 md:pl-8 md:border-l border-gray-200">
              {/* Download Receipt */}
              <button disabled className="flex items-center w-full space-x-2 bg-green-50 p-4 rounded-lg cursor-not-allowed hover:bg-gray-50 transition border border-gray-200">
                <ArrowDownTrayIcon className="h-5 w-5 text-green-600" />
                <span className="text-green-700 font-medium text-sm">Download Receipt</span>
              </button>

              {/* Managed by */}
              <div className="bg-blue-50 p-4 rounded-2xl shadow-md border border-gray-200">
                <h3 className="text-xl font-bold text-blue-900">Managed by Jagedo</h3>
              </div>

              {/* Package Details */}
              <div className="bg-blue-50 p-4 rounded-2xl shadow-md mt-4 border border-gray-200">
                <h3 className="text-lg sm:text-xl font-bold text-blue-900 mb-2">Package details</h3>
                <p className="text-base font-semibold text-gray-800">Jagedo Oversees</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white p-4 sm:p-8 shadow-lg rounded-xl border border-gray-200 my-6">
          ...
          <div className="border-b md:border-b-0 md:border-r border-gray-200 pr-0 md:pr-6">
            ...
            <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Reprehenderit minus molestiae libero et aut accusamus consequuntur.
            </p>
          </div>
              ...
              <tbody>
                {files.map((file, index) => (
                  <tr key={index} className="hover:bg-gray-50 transition-all duration-200">
                    <td className="px-4 py-3 border-t border-gray-200 break-words">{file.name}</td>
                    <td className="px-4 py-3 border-t border-gray-200">
                      <a href={file.url} download className="text-blue-900 hover:text-blue-700 flex items-center gap-2">
