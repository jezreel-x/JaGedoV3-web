...
function Quotations() {
 ...
 <section className="px-4 shadow py-5 rounded-2xl mb-9 mt-3 w-full">
          <h1 className="text-xl font-semibold text-gray-700">Jobs</h1>
          <Link to="/fundi-quote-job">
            <div className="bg-white rounded-lg p-4 border border-gray-200 cursor-pointer shadow hover:shadow-lg transition-all my-5">
              <div className="grid grid-cols-4 gap-4 items-center mb-4">
                ...
                <span className="text-[rgb(0,0,122)] font-medium justify-self-end">Under Evaluation</span>
              </div>
          ...
          <Link to="/fundi-portal/quote/builder">
            <div className="bg-white rounded-lg p-4 border border-gray-200 cursor-pointer shadow hover:shadow-lg transition-all my-5">
              <div className="grid grid-cols-4 gap-4 items-center mb-4">
                ...
                <span className="text-gray-600 font-medium">Managed by Jagedo</span>
                <span className="text-gray-600 font-medium">Req Date: {today}</span>
                <span className="text-[rgb(0,0,122)] font-medium justify-self-end">Under Quotation</span>
              </div>
              <hr className="border-gray-200 my-3" />
              <div className="grid grid-cols-4 gap-2 items-center">
                <span className="text-gray-700 font-medium">Mason</span>
