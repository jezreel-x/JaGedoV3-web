...
const tabs = [
  { name: "Specification", key: "quote", path: "/customer-view-quote" },

  { name: "Order Summary", key: "jobs", path: "/customer-view-order-summary" },
  // { name: "Order Summary", key: "progress", path: "/fundi-portal/active/progress" },
  { name: "Payment Breakdown", key: "payment", path: "/customer-view-payment-breakdown" },
  { name: "Attachment", key: "customer", path: "/customer-view-attachments" },
];
