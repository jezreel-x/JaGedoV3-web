  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-gray-100">
      ...
      <div className="flex-1 overflow-y-auto bg-white">
        <div className="w-full px-4 md:ml-[20rem]">
          <section className="w-full max-w-3xl mx-auto py-6">
            <div className="bg-white rounded-xl p-6 shadow-md">
              ...
              <div className="flex flex-col items-start mb-6">
                <Avatar size="sm" alt="avatar" src={imageSrc} />
                <button
                  type="button"
                ...
                <form className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center border-b focus-within:border-blue-900 transition">
                      ...
                      />
                      <Link to="/fundi-portal/account-info/edit-name">
                        <FiEdit
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center border-b focus-within:border-blue-900 transition">
                      <input
                        ...
                        className="w-full px-4 py-2 outline-none bg-transparent"
                      />
                      <Link to="/fundi-portal/account-info/edit-phone">
                        <FiEdit
                          className="text-blue-900 cursor-pointer hover:opacity-75"
                          size={15}
                        />
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center border-b focus-within:border-blue-900 transition">
                      <input
                        ...
                        className="w-full px-4 py-2 outline-none bg-transparent"
                      />
                      <Link to="/fundi-portal/account-info/edit-email">
                        <FiEdit
                          className="text-blue-900 cursor-pointer hover:opacity-75"
                          size={15}
                        />
