      ...
      <section className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-200 mt-32">
        ...
        <div className="flex justify-center my-2.5">
          <div className="flex">
            ...
            <label
              htmlFor="agreement"
              className="ml-2 underline font-semibold hover:text-[rgb(0,0,122)] cursor-pointer"
            >
        ...
        <div className="text-center px-4">
          <p className="text-sm text-gray-600 max-w-md mx-auto">
            Failure to adhere to the Fundi Agreement and stipulated timelines
        ...
        <div className="text-center mt-4">
          <Link to={isChecked ? "/fundi-portal/active" : "#"}>
            <button
              type="button"
