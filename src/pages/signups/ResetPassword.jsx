    ...
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
      <div className="bg-white rounded-xl p-8 shadow-md w-[90%] sm:w-full max-w-2xl">
        ...
        <form className="flex flex-col">
            <div className="mb-2">
                <label htmlFor="email" className="block text-sm sm:text-lg font-medium text-gray-700 mb-1">Email
            ...
            <button
                ...
                className="w-full py-4 my-4 hover:bg-blue-600 text-white rounded-md bg-[rgb(0,0,112)] transition duration-200 cursor-pointer"
            >
                Send Reset Link
            </button>
