...
import QuoteNavBar2 from "../../pages/contractor/ContractorPortal/AdminViewQuote/QuoteNavBar2";
    ...
    <>
      ...
      <div className="flex min-h-screen bg-white">
        ...
        <div className="flex-1 flex flex-col transition-all duration-300 relative pt-20 px-4 md:px-8 lg:px-12">
          ...
          <div className="p-8 flex justify-center flex-wrap gap-16 shadow-md">
            {[
              {
                id: "technical",
                title: "Technical",
              ...
              <div
                ...
                role="button"
                tabIndex={0}
                className={`flex-1 max-w-sm cursor-pointer p-4 text-center rounded-lg shadow transition-all font-bold ${
                  activeCard === card.id
