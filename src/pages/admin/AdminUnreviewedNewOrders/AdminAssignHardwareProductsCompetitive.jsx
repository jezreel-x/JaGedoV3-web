  ...
  const handleConfirmCancel = () => {
   ...
   useEffect(() => {
    if (method === "Competitive") {
      navigate("/admin-assign-hardware-product-competitive-unreviwed");
    } else if (method === "restricted") {
      // navigate("/admin-assign-machinery-product-restricted");
      navigate("/admin-assign-hardware-product-unreviwed");
    }
  }, [method, navigate]);
...
<br />
 ...
 {/* Delivery Details */}
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 mb-6 items-center space-y-4 sm:space-y-0">
                        ...
                        <button type='button' className="text-[rgb(0,0,122)] font-medium flex items-center gap-1 hover:underline sm:my-1.5 cursor-pointer sm:justify-self-end">
