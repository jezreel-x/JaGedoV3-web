...
const JobForm = () => {
  ...
  useEffect(() => {
    if (method === "Restricted") {
      navigate("/admin-prof-jobspecification");
  ...
  <span className="text-gray-600 font-medium">Download Receipt</span>
      ...
      <div className="grid grid-cols-4 gap-6 bg-white p-8 shadow-lg rounded-xl border border-gray-200">
        ...
        <div className="col-span-2 pr-6 border-r border-gray-200">
          ...
          <p className="text-gray-600 leading-relaxed">
            I am looking for a qualified architect to assist with the design and
            planning of a [type of project – e.g., residential house/commercial
            building/renovation]. The site is located in [location], and I would
            like a modern, functional, and cost-effective design that meets
      ...
      <div className="flex justify-between mt-6">
        {/* View Register Button */}
        <Link to="/register?skill=Architect">
          <button
            type="button"
