...
// import FundiNavBar from "./fundiLanding/FundiNavBar";
...
function JobRequestDetails() {
  ...
  const handleAssignClick = () => {
    navigate("/assignment/professional");
  };
      ...
      <div className="p-8 my-6 rounded-xl shadow-lg bg-white hover:shadow-xl transition-all duration-300">
        ...
        <div className="p-8 my-6 rounded-xl shadow-lg bg-white hover:shadow-xl transition-all duration-300 border border-gray-200">
          ...
          <div className="flex justify-between gap-8">
            ...
            <div className="w-1/2 space-y-4">
              {[
                { label: "Profession", value: "Structural Engineer" },
            ...
            <div className="w-1/2 pl-8 border-l border-gray-200 space-y-4">
              ...
              <div className="bg-blue-50 p-4 rounded-2xl shadow-md border border-gray-200">
                <h3 className="text-2xl font-bold text-blue-900">Managed by Self</h3>
              </div>

              {/* Package Details Section */}
              <div className="bg-blue-50 p-4 rounded-2xl shadow-md mt-4 border border-gray-200">
                <h3 className="text-2xl font-bold text-blue-900 mb-2">Package details</h3>
                ...
                <p className="text-lg font-semibold text-gray-800">Client Manages</p>
        ...
        <div className="grid grid-cols-4 gap-6 bg-white p-8 shadow-lg rounded-xl border border-gray-200 my-6">
          ...
          <div className="col-span-2 pr-6 border-r border-gray-200">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              molestiae libero et aut accusamus consequuntur.
            </p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-6 bg-white p-8 shadow-lg rounded-xl border border-gray-200">
          ...
          <div className="col-span-2 pr-6 border-r border-gray-200">
            ...
            <p className="text-gray-600 leading-relaxed">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Reprehenderit minus
              molestiae libero et aut accusamus consequuntur. Lorem ipsum dolor sit amet consectetur
              adipisicing elit. Iusto alias dolor doloribus eligendi libero culpa cumque laudantium
              recusandae doloremque tempore! Deleniti non enim nam ut totam facilis tempore pariatur
              qui!
            </p>
          </div>
