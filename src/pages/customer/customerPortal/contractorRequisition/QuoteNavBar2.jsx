...
const tabs = [
  { name: "Job Specification", key: "fees", path: "/contractor-job-specification" },
  { name: "Work plan", key: "quotations", path: "/contractor-workplan" },
  { name: "Bills", key: "fees", path: "/contractor-quote-creation" },
  { name: "Other expenses", key: "Other", path: "/contractor-expense" },
  { name: "Bill summary", key: "Breakdown", path: "/contractor-bill-summary" },
  { name: "Milestones", key: "milestonesast", path: "/contractor-submissions" },
  {name:"Submissions",key:"payment",path:"/contractor-attachments"}
