    ...
    <section className="container mx-auto mt-10">
      ...
      <nav className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 px-4 mt-28">
        ...
        <Link to="/hardware_shop/custom-products">
          ...
          <div className={`flex flex-row md:flex-col justify-center items-center rounded-lg shadow-md hover:bg-opacity-70 p-4 transition
            ${isActive === "/customer/custom-products/cart" ? "bg-[rgb(0,0,122)] text-white" : "bg-blue-200 text-gray-900"}`}>
            <img
      ...
      <div className="flex justify-between px-4 my-5">
        <div className="flex">
          ...
          <Link
            to="/customer/custom-products/cart"
            className="font-semibold hover:text-[rgb(0,0,122)] flex items-center justify-center text-xl">
            Cart{" "}
          </Link>
        </div>
      ...
      <section className="flex flex-col sm:flex-row justify-between items-start gap-6">
        ...
        <div className="w-[90%] mx-auto sm:w-1/3 bg-white p-6 sm:p-4 rounded-md shadow-md self-start mb-8">
