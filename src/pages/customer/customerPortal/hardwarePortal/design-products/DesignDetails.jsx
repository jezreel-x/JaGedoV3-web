...
export default function DesignDetails() {
  ...
  useEffect(() => {
    ...
    const storedProduct = localStorage.getItem(`designs`);
    if (storedProduct) {
  ...
  return (
    <div className="flex flex-col p-6 max-w-6xl mx-auto">
        ...
        <div className="relative border border-gray-400 shadow-lg w-full rounded-lg mt-2 bg-white mx-auto px-4 sm:px-6 lg:px-4 py-8">
                ...
                <section className="w-full lg:w-1/2">
                    <div className="bg-white p-6 flex flex-col lg:flex-row gap-4">
                        ...
                        <div className="w-full lg:w-3/4">
                            <img
                                src={product.image}
                                alt="Nguvu Cement mh-[500px]ain view"
                    ...
                    <div className="bg-white p-6 flex flex-col justify-between">
                       <div className="flex items-center gap-2 mb-4">
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-4 mt-8">
                            ...
                            <button 
                                type="button"
                                onClick={() => navigate("/hardware_shop/all-products/cart/cart-detail/cart/design-checkout")} 
