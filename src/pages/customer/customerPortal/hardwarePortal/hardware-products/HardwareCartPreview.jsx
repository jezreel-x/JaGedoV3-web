...
export default function HardwareCartPreview() {
  // const { id } = useParams();
  ...
  const handleAddToCart = () => {
    ...
    if (index !== -1) {
        ...
        toast.success("Product already in cart, updating quantity!");
                ...
                <section className="w-full md:w-1/2">
                    <div className="bg-white p-6 flex flex-col justify-between">
                        <div className="flex items-center gap-2 mb-4">
                                ...
                                <h1 className="text-lg font-bold">{product.subCategoryName}</h1> |
