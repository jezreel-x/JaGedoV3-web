...
const ProBillSummary = () => {
  ...
  const handleClick = () => {
    if (isChecked) navigate("/professional-portal/quotations");
  };
  ...
  return (
    <>
      <NavigationBar />
      <div className="container mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-200 mt-32 lg:px-8 py-8 relative">
        <QuoteNavBar />
