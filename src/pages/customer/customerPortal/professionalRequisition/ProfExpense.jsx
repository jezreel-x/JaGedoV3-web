...
const ProBillSummary = () => {
  ...
  const handleChange = (index, field, value) => {
    ...
    if (field === "amount") {
      ...
      updatedExpenses[index][field] = cleanedValue;
    } else {
  ...
  const handleAddRow = () => {
    if (expenses.length < 6) {
      setExpenses([
        ...expenses,
        { label: `New Expense ${expenses.length - 2}`, amount: "" },
      ]);
    }
  };
  ...
  return (
    ...
    <div className="container mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-200 mt-32 lg:px-8">
      ...
      <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-md hover:shadow-lg transition-shadow duration-300">
                ...
                <tr key={index}>
                  <td className="px-4 py-3">
                    <input
                      ...
                      className="w-full px-2 py-1 text-gray-700 bg-transparent focus:outline-none focus:ring-2 focus:ring-blue-600"
                    />
                  </td>
                  <td className="px-4 py-3 text-right">
                    <input
                      ...
                      className="w-full text-right px-2 py-1 text-gray-700 bg-transparent focus:outline-none focus:ring-2 focus:ring-blue-600"
                      inputMode="numeric"
                      pattern="[0-9]*"
                    />
                  </td>
        ...
        <div className="mt-6">
          <button
            type="button"
            className={`${
              expenses.length >= 6 ? "bg-gray-400 cursor-not-allowed" : "bg-blue-700 hover:bg-blue-800"
      ...
      <div className="mt-8 space-y-4 flex flex-col items-end">
        {[
          { label: "Sub-Total (Kes)", value: 5000000 },
      ...
      <div className="flex justify-between mt-6 space-x-4">
        ...
        <button
          onClick={() => navigate("/professional-grand-summary")}
