    ...
    <Card className="fixed top-0 left-0 h-screen w-full max-w-[20rem] p-4 shadow-xl rounded-r-xl bg-white border-r border-gray-200">
      ...
      <List className="space-y-2">
        <Link to="/customer/manage-account">
          <ListItem
            className={`hover:bg-blue-50 transition-all duration-200 ${
              isActiveRoute("/customer/manage-account") ? "underline underline-offset-4 font-semibold bg-blue-50" : ""
            }`}
          >
            <ListItemPrefix>
        ...
        <Link to="/customer/address">
          <ListItem
            className={`hover:bg-blue-50 transition-all duration-200 ${
              isActiveRoute("/customer/address") ? "underline underline-offset-4 font-semibold bg-blue-50" : ""
            }`}
          >
            <ListItemPrefix>
        ...
        <Link to="/customer/uploads">
          <ListItem
            className={`hover:bg-blue-50 transition-all duration-200 ${
              isActiveRoute("/customer/uploads") ? "underline underline-offset-4 font-semibold bg-blue-50" : ""
            }`}
          >
            <ListItemPrefix>
