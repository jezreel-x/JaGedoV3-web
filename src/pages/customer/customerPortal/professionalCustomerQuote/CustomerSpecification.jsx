...
function JobRequestDetails() {
  ...
  return (
    <section className="container mx-auto mt-16 px-4">
      {/* Lazy-loaded NavigationBar (not restricted inside a card) */}
      <Suspense fallback={<div>Loading navigation...</div>}>
        <NavigationBar />
      </Suspense>
<br></br>

      {/* Second navbar also unrestricted */}
      <QuoteNavBar />
      ...
      <div className="p-8 my-6 rounded-xl shadow-lg bg-white hover:shadow-xl transition-all duration-300 border border-gray-200">
        ...
        {/* <div className="mt-8 flex justify-end">
          <button
            type="button"
            onClick={handleNext}
            className="bg-blue-900 hover:bg-blue-800 text-white font-semibold py-2 px-6 rounded-lg"
          >
            Next
          </button>
        </div> */}
