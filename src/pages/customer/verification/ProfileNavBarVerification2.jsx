import {
  ...
  import { FaBoxes, FaHome, FaUser } from "react-icons/fa";
     ...
     const navItems = [
        {
          label: "Account Info",
          icon: FaUser,
          path: "/organization/organization-verification",
          color: "text-blue-600",
        },
        {
          label: "Address",
          icon: FaHome,
          path: "/organization/organization-verification/organization-address",
          color: "text-green-600",
        },
        {
          label: "Account Uploads",
          icon: FaBoxes,
          path: "/organization/organization-verification/organization-uploads",
