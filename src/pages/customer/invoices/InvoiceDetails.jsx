...
export default function ReceiptDetails() {
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg mt-32">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <button className="flex items-center justify-center gap-2 px-4 py-2 border border-gray-300 text-gray-700 rounded-md hover:bg-gray-100 text-sm">
            <Mail className="h-4 w-4" />
            Send Receipt
          </button>
        </div>
