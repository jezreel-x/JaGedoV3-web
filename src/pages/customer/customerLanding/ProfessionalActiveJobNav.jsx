...
const tabs = [
  { name: "job specification", key: "job-specification", path: "/customer-view-active-prof-job-specification" },
  { name: "Progress", key: "progress", path: "/customer-view-active-prof-progress" },
  { name: "Quote", key: "quote", path: "/customer-prof/quoteform" },

  // { name: "Draft", key: "draft", path: "/customer/draft" },
  { name: "Builder", key: "customer", path: "/customer-view-prof-builders" },
