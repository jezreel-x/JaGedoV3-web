...
const tabs = [
  { name: "job specification", key: "job-specification", path: "/admin-view-cont-active-job-specification" },
  { name: "Progress", key: "progress", path: "/admin-view-cont-active-job" },
  { name: "Builder", key: "draft", path: "/admin-view-cont-builders" },
  { name: "Customer", key: "customer", path: "/admin-view-cont-customers" },
  { name: "Quote", key: "quote", path: "/admin/view-cont/quoteform" },
