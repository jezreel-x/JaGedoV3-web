...
const tabs = [
  { name: "job specification", key: "job-specification", path: "/customer-view-active-job-specification" },
  { name: "Progress", key: "progress", path: "/customer-view-active-job" },
  { name: "Quote", key: "quote", path: "/customer/quoteform" },

  // { name: "Draft", key: "draft", path: "/customer/draft" },
  { name: "Builder", key: "customer", path: "/customer-view-builders" },
