...
const tabs = [
  { name: "job specification", key: "job-specification", path: "/fundi-view-past-job-specification" },
  { name: "Progress", key: "progress", path: "/fundi-portal/past/progress" },
  
  // { name: "Draft", key: "draft", path: "/customer/draft" },
  // { name: "Builder", key: "customer", path: "/Builders" },
  { name: "Quote", key: "quote", path: "/fundi/past/quoteform" },
