...
const tabs = [
  { name: "job specification", key: "job-specification", path: "/customer-view-past-cont-jobspecification" },
  { name: "Progress", key: "progress", path: "/customer-view-past-cont-progress" },
  { name: "Quote", key: "quote", path: "/custome-view-past-cont/job/quoteform" },

  // { name: "Draft", key: "draft", path: "/customer/draft" },
  { name: "Builder", key: "customer", path: "/customer-view-cont-past-builders" },
