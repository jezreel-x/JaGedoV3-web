...
const tabs = [
  { name: "Requisition", key: "requisitions", path: "/customer" },
  { name: "New", key: "new", path: "/customer/new" },
  { name: "Draft", key: "draft", path: "/customer/draft" },
  { name: "Bids", key: "quotations", path: "/customer/quotations" },
  { name: "Active", key: "active", path: "/customer/active" },
  { name: "Past", key: "past", path: "/customer/past" },
];
