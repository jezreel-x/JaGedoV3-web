...
const tabs = [
  { name: "job specification", key: "job-specification", path: "/admin-view-fundi-active-job-specification" },
  { name: "Progress", key: "progress", path: "/admin-view-fundi-active-job" },
  { name: "Builder", key: "draft", path: "/admin-view-fundi-builders" },
  { name: "Customer", key: "customer", path: "/admin-view-fundi-customers" },
  { name: "Quote", key: "quote", path: "/admin/view-fundi/quoteform" },
