...
const tabs = [
  { name: "job specification", key: "job-specification", path: "/admin-view-active-job-specification" },
  { name: "Progress", key: "progress", path: "/admin-view-active-job" },
  { name: "Builder", key: "draft", path: "/admin-view-builders" },
  { name: "Customer", key: "customer", path: "/admin-view-customers" },
  { name: "Quote", key: "quote", path: "/admin/view/quoteform" },
