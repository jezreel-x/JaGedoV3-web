...
const tabs = [
  { name: "job specification", key: "job-specification", path: "/professional-view-past-jobspecification" },
  { name: "Progress", key: "progress", path: "/professional-view-past-prof-progress" },
  { name: "Quote", key: "quote", path: "/professional-view-past-prof-projectquote" },

  // { name: "Draft", key: "draft", path: "/customer/draft" },
  { name: "Builder", key: "customer", path: "/professional-view-past-customer" },
