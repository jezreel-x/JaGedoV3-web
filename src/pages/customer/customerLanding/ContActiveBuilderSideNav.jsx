...
const tabs = [
  { name: "job specification", key: "job-specification", path: "/contractor-view-active-job-specification" },
  { name: "Progress", key: "progress", path: "/contractor-view-active-job-progress" },
  { name: "Quote", key: "quote", path: "/contractor-job/quoteform" },

  // { name: "Draft", key: "draft", path: "/customer/draft" },
  { name: "Customer", key: "customer", path: "/contractor-view-customer" },
