...
const tabs = [
  { name: "job specification", key: "job-specification", path: "/customer-view-past-job-specification" },
  { name: "Progress", key: "progress", path: "/customer-view-past-job" },
  // { name: "Draft", key: "draft", path: "/customer/draft" },
  // { name: "Customer", key: "customer", path: "/customers" },
  { name: "Quote", key: "quote", path: "/customer/past/quoteform" },
