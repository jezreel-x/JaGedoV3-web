...
const tabs = [
  { name: "job specification", key: "job-specification", path: "/customer-view-active-cont-job-specification" },
  { name: "Progress", key: "progress", path: "/customer-view-active-cont-progress" },
  { name: "Quote", key: "quote", path: "/customer-cont/quoteform" },

  // { name: "Draft", key: "draft", path: "/customer/draft" },
  { name: "Builder", key: "customer", path: "/customer-view-cont-builders" },
