...
const tabs = [
  { name: "job specification", key: "job-specification", path: "/professional-view-active-job-specification" },
  { name: "Progress", key: "progress", path: "/professional-view-active-job-progress" },
  { name: "Quote", key: "quote", path: "/professional-job/quoteform" },

  // { name: "Draft", key: "draft", path: "/customer/draft" },
  { name: "Customer", key: "customer", path: "/professional-view-customer" },
