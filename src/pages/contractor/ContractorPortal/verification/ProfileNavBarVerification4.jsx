...
const navItems = [
  {
    label: "Account Info",
    icon: FaUser,
    path: "/contractor/contractor-verification",
    color: "text-blue-600",
  },
  {
    label: "Address",
    icon: FaHome,
    path: "/contractor/contractor-verification/contractor-address",
    color: "text-green-600",
  },
  {
    label: "Account Uploads",
    icon: FaBoxes,
    path: "/contractor/contractor-upload",
    color: "text-purple-600",
  },
  {
    label: "Experience",
    icon: FaCubes,
    path: "/contractor/contractor-experience",
    color: "text-yellow-600",
  },
  {
    label: "Products",
    icon: FaCity,
    path: "/contractor/contractor-product",
