        ...
        <div className="p-8 my-6 rounded-xl shadow-lg bg-white hover:shadow-xl transition-all duration-300 border border-gray-200">
          ...
          <div className="flex justify-between gap-8">
            ...
            <div className="w-1/2 pl-8 border-l border-gray-200 space-y-4">
              ...
              <div className="flex items-center space-x-2 bg-gray-100 p-4 rounded-lg cursor-not-allowed hover:bg-gray-200 transition border border-gray-300">
                {/* Download Icon */}
                <svg
        ...
        <div className="grid grid-cols-4 gap-6 bg-white p-8 shadow-lg rounded-xl border border-gray-200">
          ...
          <div className="col-span-2 pr-6 border-r border-gray-200">
            ...
            <p className="text-gray-600 leading-relaxed">
              I am looking for a qualified architect to assist with the design
              and planning of a [type of project – e.g., residential
              house/commercial building/renovation]. The site is located in
              [location], and I would like a modern, functional, and
              cost-effective design that meets local building regulations.
            </p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-6 bg-white p-8 shadow-lg rounded-xl border border-gray-200">
          <div className="col-span-2 pr-6 border-r border-gray-200">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              Reprehenderit minus molestiae libero et aut accusamus
              consequuntur.
            </p>
          </div>
          ...
          <div className="mt-6">
            <button
              onClick={() => navigate("/customer/new1")}
