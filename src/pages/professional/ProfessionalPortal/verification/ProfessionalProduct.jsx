            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
              ...
              <div className="max-w-4xl">
                ...
                <div className="flex gap-4 mt-5">
                  <Link to="/professional-portal/products/add-product">
                    <button
                      type="button"
                      className="bg-[rgb(0,0,122)] text-white px-6 py-2.5 rounded-lg hover:bg-[rgb(0,0,150)] transition-all duration-300 flex items-center gap-2 shadow-sm"
                    >
                      <svg
                        className="w-5 h-5"
                        fill="none"
