  ...
  return (
    <section className="container mx-auto mt-7">
      ...
      <div className="grid gap-6 max-w-4xl mx-auto">
        <ChatBot />
        {/* Past Requests */}
        <section className="px-4 shadow py-5 rounded-2xl mb-3 mt-2 w-full">
          <h1 className="text-2xl font-semibold text-gray-700">Jobs</h1>
          {/* <Link to="/professional-draft/job">
          ...
          <Link to="/professional-view-draft-prof-job">
            <div className="bg-white rounded-lg p-4 border border-gray-200 cursor-pointer shadow hover:shadow-lg transition-all my-5">
              <div className="grid grid-cols-4 gap-4 items-center mb-4">
                <span className="font-medium text-gray-800">POO1</span>
                ...
                <span className="text-[rgb(0,0,122)] font-medium justify-self-center fle">Ongoing</span>
              </div>
              <hr className="border-gray-200 my-3" />
              <div className="grid grid-cols-4 gap-2 items-center">
                <span className="text-gray-700 font-medium">Architect</span>
          ...
          <div className="flex justify-end mr-3">
            <button type="button" className="text-[rgb(0,0,122)] font-bold hover:underline">
              View more
            </button>
          </div>
        </section>
