...
const tabs = [
  { name: "New", key: "new", path: "/professional-portal" },
  { name: "Draft", key: "draft", path: "/professional-portal/draft" },
  { name: "Bids", key: "quotations", path: "/professional-portal/quotations" },
  { name: "Active", key: "active", path: "/professional-portal/active" },
  { name: "Past", key: "past", path: "/professional-portal/past" },
];
